...
export const CSV_ENTITIES = [
  ...
  { key: "fan_invites", label: "Fãs: convites/RSVP", table: "fan_invites" },
  { key: "tasks", label: "Tarefas", table: "tasks" },
  { key: "meetings", label: "Reuniões", table: "meetings" },
  { key: "content", label: "Conteúdos", table: "content" },
  { key: "content_raw_media", label: "Conteúdo: matéria-prima (mídia da GIG)", table: "content_raw_media" },
  ...
  { key: "document_groups", label: "Biblioteca: Grupos de documentos", table: "document_groups" },
  { key: "priorities", label: "Produtividade: Top 3 (dia/semana)", table: "priorities" },
  { key: "journal_entries", label: "Produtividade: Diário/Revisão", table: "journal_entries" },
] as const;
