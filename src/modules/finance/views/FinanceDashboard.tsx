...
const INCOME_COLORS = ["#10b981", "#3b82f6", "#f59e0b", "#a855f7", "#06b6d4", "#ec4899", "#84cc16", "#f97316"];
const EXPENSE_COLORS = ["#ef4444", "#f97316", "#eab308", "#8b5cf6", "#06b6d4", "#10b981", "#ec4899", "#64748b"];
