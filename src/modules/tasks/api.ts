...
// ============================================================
// Tarefas-padrão sugeridas ao criar uma GIG
// ============================================================

/** Template de tarefa padrão; offsetDays é relativo à data da GIG. */
export type StandardTaskTemplate = {
  title: string;
  description?: string;
  priority: TaskPriority;
  offsetDays: number; // negativo = antes da GIG, positivo = depois
};

export const STANDARD_GIG_TASKS: StandardTaskTemplate[] = [
  {
    title: "Enviar dados bancários para pagamento",
    priority: "Média",
    offsetDays: -7,
  },
  {
    title: "Preparar setlist / curadoria",
    priority: "Alta",
    offsetDays: -5,
  },
  {
    title: "Confirmar com o contato do local",
    description: "Confirmar horário, equipamento, dress code, pagamento.",
    priority: "Alta",
    offsetDays: -3,
  },
  {
    title: "Checar e arrumar equipamento",
    priority: "Média",
    offsetDays: -1,
  },
  {
    title: "Enviar agradecimento ao promoter",
    priority: "Baixa",
    offsetDays: 1,
  },
  {
    title: "Pedir mídia / fotos / vídeos",
    priority: "Média",
    offsetDays: 2,
  },
];

export function computeDueDate(gigDate: string, offsetDays: number): string {
